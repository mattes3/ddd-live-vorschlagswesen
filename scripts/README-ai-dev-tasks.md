...
_This is a 3-step workflow by Ryan Carson. It is open source (Apache-2.0 license). I (Matthias) copied it from [his GitHub repo](https://github.com/snarktank/ai-dev-tasks) and adapted it for the architecture of this project._

_Now let's see what Ryan wrote: 👇_
